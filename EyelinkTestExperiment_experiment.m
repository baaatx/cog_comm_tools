...
try
    ...
    % create a new logger
    myLog = TDFLog(['participants/' participantId '/elTest.txt']);
    ...
    displayInstructions(window, 'You will see cross-hairs appear at different\n\npositions on the screen.\n\nJust look at the cross-hairs as they move around. ');
    clearWindow(window);
    Eyelink('OpenFile','elTest.edf')
    ...
    displayCrossHairs(window, 20, 20);
    myLog.add(num2str(GetSecs() - startTime));    
    WaitSecs(waitTime);
        
    displayCrossHairs(window,  resolution.width-20,  resolution.height-20);
    myLog.add(num2str(GetSecs() - startTime));    
    WaitSecs(waitTime);
    ...
    displayCrossHairs(window,  resolution.width-20,  20);
    myLog.add(num2str(GetSecs() - startTime));    
    WaitSecs(waitTime);
    
    displayCrossHairs(window,  20, resolution.height-20);
    myLog.add(num2str(GetSecs() - startTime));
    WaitSecs(waitTime);    
