...
function [answer, responseTime] = leftRightDialog(window, questionMessage)
    ...
    [xPad, yPad] = getScreenPadding(window);
    ...
    cog_comm_tools.drawTextAtPosition(window, questionMessage, xPad, yPad);
    cog_comm_tools.drawTextAtPosition(window, 'Z: No' , 200 , resolution.height - yPad);
    cog_comm_tools.drawTextAtPosition(window, '/?: Yes' , resolution.width - (2*xPad) , resolution.height - yPad);
